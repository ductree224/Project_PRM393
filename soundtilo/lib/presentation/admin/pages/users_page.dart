...
class _AdminUsersPageState extends State<AdminUsersPage> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _FilterToolbar(
                      ...
                      onSubscriptionTierChanged: (tier) => context
                          .read<AdminUsersBloc>()
  ...
  void _onPremiumToggle(BuildContext context, AdminUserEntity user) {
    if (user.isPremium) {
      context.read<AdminUsersBloc>().add(
      ...
      context.read<AdminUsersBloc>().add(
        AdminUsersGrantPremiumRequested(userId: user.id),
      );
    }
  }
          ...
          builder: (context, setState) {
            return AlertDialog(
              ...
              content: DropdownButtonFormField<String>(
                key: ValueKey('role-dialog-$selectedRole'),
...
class _FilterToolbar extends StatelessWidget {
  ...
  final ValueChanged<String?> onSubscriptionTierChanged;
  ...
  const _FilterToolbar({
    ...
    required this.onSubscriptionTierChanged,
  });
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: DropdownButtonFormField<String?>(
                        key: ValueKey('tier-$subscriptionTier'),
                        initialValue: subscriptionTier,
                        dropdownColor: const Color(0xFF252525),
                        decoration: _toolbarDecoration('Tier'),
                        style: const TextStyle(color: Colors.white),
                        items: const [
                          DropdownMenuItem<String?>(
                            value: null,
                        ...
                        onChanged: onSubscriptionTierChanged,
                      ),
                    ),
                  ],
                ),
          ...
          return Row(
            children: [
              ...
              Expanded(
                flex: 2,
                child: DropdownButtonFormField<String?>(
                  key: ValueKey('role-desktop-$role'),
                  initialValue: role,
                  dropdownColor: const Color(0xFF252525),
                  decoration: _toolbarDecoration('Role'),
                  style: const TextStyle(color: Colors.white),
              ...
              Expanded(
                flex: 2,
                child: DropdownButtonFormField<bool?>(
                  key: ValueKey('ban-desktop-$isBanned'),
                  initialValue: isBanned,
                  dropdownColor: const Color(0xFF252525),
                  decoration: _toolbarDecoration('Status'),
                  style: const TextStyle(color: Colors.white),
              ...
              Expanded(
                flex: 2,
                child: DropdownButtonFormField<String?>(
                  key: ValueKey('tier-desktop-$subscriptionTier'),
                  initialValue: subscriptionTier,
                  dropdownColor: const Color(0xFF252525),
                  decoration: _toolbarDecoration('Tier'),
                  style: const TextStyle(color: Colors.white),
            ...
            Wrap(
              ...
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  icon: Icon(user.isPremium ? Icons.star_border : Icons.star),
                  label: Text(user.isPremium ? 'Revoke' : 'Premium'),
                ),
                OutlinedButton.icon(
